...
from apps.core.flask import restful
from apps.views.global_data.process.global_data import get_global_site_data  #,get_global_media
...
def api_current_global():
    ...
    GET:
        ...
        :return:
    '''
    response = get_global_site_data(req_type="api")
